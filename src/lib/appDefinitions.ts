...
export const APP_DEFINITIONS: AppDefinition[] = [
  ...
  // Video
  { id: "youtube", name: "YouTube", icon: "", color: "#FF0000", category: "video" },
  ...
  { id: "telegram", name: "Telegram", icon: "", color: "#2AABEE", category: "messaging" },
  ...
  { id: "minecraft", name: "Minecraft", icon: "", color: "#5B8C3E", category: "gaming" },
  { id: "clashofclans", name: "Clash of Clans", icon: "", color: "#F4A828", category: "gaming" },
  { id: "fortnite", name: "Fortnite", icon: "", color: "#00D4FF", category: "gaming" },
  { id: "mobilegame", name: "Mobile Games", icon: "", color: "#7C3AED", category: "gaming" },
  ...
  { id: "soundcloud", name: "SoundCloud", icon: "", color: "#FF5500", category: "music" },
  { id: "podcasts", name: "Podcasts", icon: "", color: "#9B59B6", category: "music" },
];
